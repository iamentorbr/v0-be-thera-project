...
const tickets = [
  {
    id: "TK-2023-001",
    subject: "Problema ao agendar sessões recorrentes",
    status: "in-progress",
  ...
  {
    id: "TK-2023-002",
    subject: "Dúvida sobre integração com Google Calendar",
    status: "resolved",
  ...
  {
    id: "TK-2023-005",
    subject: "Problema com notificações de lembretes",
    status: "resolved",
  ...
  return (
    <div className="container max-w-5xl py-6 lg:py-10">
      ...
      <div className="my-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <Button asChild>
          <Link href="/therapist/help/contact">
