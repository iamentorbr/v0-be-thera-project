        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="tuesday" checked={availableDays.tuesday} onCheckedChange={() => toggleDay("tuesday")} />
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Permitir que clientes agendem sessões para o mesmo dia.</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Limitar quanto tempo no futuro os clientes podem agendar.</p>
            </div>
            <Select defaultValue="60">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Exigir que clientes confirmem a presença antes da sessão.</p>
            </div>
