...
import { BrandCustomization } from "./brand-customization"
    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="branding">Personalização de Marca</TabsTrigger>
        ...
        <TabsContent value="branding">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Personalize cores e logo para manter sua identidade visual consistente</CardDescription>
            </CardHeader>
            <CardContent>
              <BrandCustomization />
            </CardContent>
